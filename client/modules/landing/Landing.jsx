		   ...
		   return (
				 <div>
		  	 	<div className='container'>
						...
						<button className='pull-right btn btn-social-icon btn-facebook mt2'   onClick={(event) => { this.handleFblogin(event);}}> <span class="fa fa-facebook"></span>Continue With Facebook</button>
